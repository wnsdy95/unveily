// Generated by scripts/update-public-suffix-list.mjs.
...
export const PUBLIC_SUFFIX_LIST_VERSION = "2026-07-15_18-13-59_UTC";
export const PUBLIC_SUFFIX_LIST_COMMIT = "9b5c814414374aa19a93dc6dd7e47c01909524cc";

const EXACT_RULES = new Set(`0.bg
0am.jp
0g0.jp
0j0.jp
0t0.jp
...
zushi.kanagawa.jp
zw`.split("\n"));
const WILDCARD_ROOTS = new Set(`001.test.code-builder-stg.platform.salesforce.com
0e.vc
0emm.com
aa.crm.dev
ab.crm.dev
...
zerops.app
zerops.zone`.split("\n"));
const EXCEPTION_RULES = new Set(`city.kawasaki.jp
city.kitakyushu.jp
city.kobe.jp
city.nagoya.jp
city.sapporo.jp
